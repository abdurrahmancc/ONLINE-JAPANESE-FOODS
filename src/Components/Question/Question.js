    ...
    <div className="container my-5 ">
      <Accordion defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            <h4>
              অ্যাপ্লিকেশানের লজিক কে সহজ করার জন্য React এ অনেকগুলি hooks ব্যবহার করা হয়।
              <br /> যখন কোনো ইউজার ব্রাউজারে কোনো কিছু চেঞ্জ করে বা ইন্টার‍্যাক্ট করে তখন ব্রাউজার
              কে বুঝানোর জন্য useState ব্যবহার করা হয় ।
            </h4>
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
